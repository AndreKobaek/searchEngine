...
This solution has the \code{Score} interface as required. Another big improvement we made, was to remove the score/rank field from \code{Website}, and instead use the value from \code{rank} method directly to do the sorting.  
